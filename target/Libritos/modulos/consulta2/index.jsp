...
<div id="wrapper">
                        ...
                        <div class="col-md-6">
                            <div class="card m-b-20">
                                <div class="card-body">
                                    ...
                                    <input type="Date" autocomplete="off" name="fechaPrestam"
                                           data-parsley-error-message="Campo requerido" id="fechaPrestam"
                                           class="form-control"/>
                                </div>
                            </div>
                        </div>
    ...
    <script src="./modulos/consulta2/funciones_consulta2.js"></script>